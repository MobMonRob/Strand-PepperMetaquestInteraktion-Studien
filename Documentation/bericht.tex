...
\begin{abstract}
Diese Studienarbeit beschreibt die Herstellung einer Verbindung zwischen dem humanoiden Roboter Pepper und einer Virtual-Reality Brille. Das Kamerabild des Roboters soll auf der Brille angezeigt werden um diesen dann, mit Hilfe der Controller steuern zu können.  Um dies zu verwirklichen wird eine Middleware- Lösung implementiert, welche die Kommunikation zwischen den verschiedenen Systemen ermöglicht. Abschließend sollen die Ergebnisse mit einer  Evaluation, welche die Praxistauglichkeit des Projektes prüfen soll, überprüft werden.
\end{abstract}
...
\include{Umsetzung}
\include{Benutzerstudie}
\include{Anwendungsgebiete}
\include{Fazit}
\include{Fortsetzung}
